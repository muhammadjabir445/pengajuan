...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 20, 2020 at 09:55 AM
...
CREATE TABLE `barangs` (
  ...
  `nama` varchar(180) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Dumping data for table `parent_pengajuans`
--

INSERT INTO `parent_pengajuans` (`id`, `nomor_surat`, `status`, `divisi`, `tanggal_pengajuan`, `created_by`, `deleted_at`, `created_at`, `updated_at`) VALUES
(8, '001/PPB/Developer/HRD/XI/2020', 3, 23, '2020-11-20', 1, NULL, '2020-11-19 23:59:38', '2020-11-20 00:04:20');
...
INSERT INTO `pembelians` (`id`, `nomor_surat`, `id_pengajuan`, `created_at`, `updated_at`, `deleted_at`) VALUES
(3, '001/SPB/Developer/HRD/XI/2020', 8, '2020-11-20 00:04:20', '2020-11-20 00:04:20', NULL);
...
INSERT INTO `pembelian_details` (`id`, `id_barang`, `id_pengajuan`, `id_pembelian`, `input_by`, `harga`, `tempat_beli`, `foto`, `status`, `created_at`, `updated_at`, `deleted_at`) VALUES
(3, 3, 6, 3, NULL, NULL, NULL, NULL, 0, '2020-11-20 00:04:20', '2020-11-20 00:04:20', NULL);
...
CREATE TABLE `pengajuans` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `saran_coo` varchar(180) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tempat_pembelian` varchar(180) COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `pengajuans` (`id`, `id_barang`, `perkiraan_harga`, `total`, `keterangan`, `tujuan_pengadaan`, `status_pengajuan`, `alasan_tolak`, `created_by`, `id_divisi`, `id_parent`, `deleted_at`, `created_at`, `updated_at`, `saran_coo`, `tempat_pembelian`) VALUES
(6, 3, 10000, 2, 'fsfds', 'dfsf', 3, NULL, 1, 23, 8, NULL, '2020-11-19 23:59:54', '2020-11-20 00:04:16', NULL, 'fsfsdf');
...
CREATE TABLE `role_menu` (
  ...
  `parent_menu` varchar(180) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `child_menu` varchar(180) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
